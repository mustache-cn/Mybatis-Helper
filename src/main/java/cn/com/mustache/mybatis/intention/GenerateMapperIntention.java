...
import cn.com.mustache.mybatis.service.EditorService;
import cn.com.mustache.mybatis.template.MybatisFileTemplateDescriptorFactory;
import cn.com.mustache.mybatis.ui.ClickableListener;
import cn.com.mustache.mybatis.ui.ListSelectionListener;
import cn.com.mustache.mybatis.ui.UiComponentFacade;
...
public class GenerateMapperIntention extends GenericIntention {
    ...
    public void invoke(@NotNull final Project project, final Editor editor, PsiFile file) throws IncorrectOperationException {
        ...
        Collection<PsiDirectory> directories = MapperUtil.findMapperDirectories(project);
    ...
    private void processGenerate(Editor editor, PsiClass clazz, PsiDirectory directory) {
        ...
        try {
            ...
            PsiElement psiFile = MapperUtil.createMapperFromFileTemplate(MybatisFileTemplateDescriptorFactory.MYBATIS_MAPPER_XML_TEMPLATE,
