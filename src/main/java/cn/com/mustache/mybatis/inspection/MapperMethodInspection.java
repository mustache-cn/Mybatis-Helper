...
import cn.com.mustache.mybatis.generate.StatementGenerator;
import cn.com.mustache.mybatis.locator.MapperLocator;
...
public class MapperMethodInspection extends MapperInspection {
    ...
    public ProblemDescriptor[] checkMethod(
        ...
        if (!MapperLocator.getInstance(method.getProject()).process(method) ||
                JavaUtil.isAnyAnnotationPresent(method, Annotation.STATEMENT_SYMMETRIES)) {
            return EMPTY_ARRAY;
        }
