...
import cn.com.mustache.mybatis.dom.model.Package;
import cn.com.mustache.mybatis.dom.model.TypeAlias;
import cn.com.mustache.mybatis.dom.model.TypeAliases;
...
public final class MapperUtil {
    ...
    public static Optional<IdDomElement> findParentIdDomElement(@Nullable PsiElement element) {
        DomElement domElement = com.intellij.util.xml.DomUtil.getDomElement(element);
        if (null == domElement) {
        ...
        return Optional.ofNullable(com.intellij.util.xml.DomUtil.getParentOfType(domElement, IdDomElement.class, true));
    }
    ...
    public static boolean isElementWithinMybatisFile(@NotNull PsiElement element) {
        ...
        return element instanceof XmlElement && DomUtil.isMybatisFile(psiFile);
    }

    @NotNull
    @NonNls
    public static Collection<Mapper> findMappers(@NotNull Project project) {
        return DomUtil.findDomElements(project, Mapper.class);
    }
    ...
    public static Collection<Mapper> findMappers(@NotNull Project project, @NotNull PsiClass clazz) {
        return JavaUtil.isElementWithinInterface(clazz) ? findMappers(project, clazz.getQualifiedName()) : Collections.<Mapper>emptyList();
    }
    ...
    public static Mapper getMapper(@NotNull DomElement element) {
        Optional<Mapper> optional = Optional.ofNullable(com.intellij.util.xml.DomUtil.getParentOfType(element, Mapper.class, true));
    ...
    private static Collection<Configuration> getMybatisConfigurations(Project project) {
        return DomUtil.findDomElements(project, Configuration.class);
    }
